...
/*
  ...
  */
    ...
    public List<List<WiFiAccessPoint>> getWifiAPListByLocation(){
         ...
         */
        String queryLocationTableForNumberOfLocations = "SELECT MAX(" + DatabaseTest.LOCATION_TABLE_COL_ID + ") FROM " + DatabaseTest.LOCATION_TABLE + ";";
         ...
         */
        String queryString = "SELECT "
                + DatabaseTest.WIFIAPTABLE_COL_SSID + ", "
                + DatabaseTest.WIFIAPTABLE_COL_BSSID + ", "
                + DatabaseTest.WIFIAPTABLE_COL_RSSI + ", "
                + DatabaseTest.WIFIAPTABLE_COL_PARENTID + " "
                + "FROM " + DatabaseTest.WAP_TABLE
                + ";";
